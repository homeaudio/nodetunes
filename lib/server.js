...
class NodeTunes extends EventEmitter {
    ...
    constructor(options) {
        ...
        options.controlTimeout = (options.controlTimeout !== undefined && 
                                  options.controlTimeout !== null ? options.controlTimeout : 5)
    ...
    start(callback) {
        ...
        portastic.find({
            ...
            this.netServer = net.createServer(this.rtspServer.connectHandler.bind(this.rtspServer)).listen(port, () => {
