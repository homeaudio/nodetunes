...
const decoderStreams = { '96 AppleLossless': AlacDecoderStream, '96 L16/44100/2': PcmDecoderStream }
...
function announceParse(rtspServer, req, res) {
    ...
    const decoderStream = new decoderStreams[rtspServer.audioCodec](decoderOptions)
